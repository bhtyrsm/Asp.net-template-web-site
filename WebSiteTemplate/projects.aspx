<%@ Page Title="" Language="C#" MasterPageFile="~/main.Master" AutoEventWireup="true" CodeBehind="projects.aspx.cs" Inherits="WebSiteTemplate.projects" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="mainContent">
				<h2>Project Name</h2>
				<div class="img-box">
					<img src="Contents/images/img5.jpg" alt="" /><h5>Et harum quidem rerum facilis est et expedita</h5>
					Nam libero tempore, cum soluta nobis est eligendi optio cumque nihil impedit quo minus id quod maxime placeat facere possimus, omnis voluptas assumenda est, omnis dolor repellendus emporibus autem quibusdam et aut officiis debitis aut rerum necessitatibus.
				</div>
